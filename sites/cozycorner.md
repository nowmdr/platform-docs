...
> Last updated: 2026-07-17 | Source project: cozycorner (CLAUDE.md, docs/page-content.md, docs/product-images.md) — пути файлов относятся к репозиторию `cozycorner/`
...
components/           # один компонент = файл + CSS Module; каталог — docs/design-system.md
  Header.tsx          # шапка: навигация + лого + SearchBox + бургер; sticky auto-hide
